defmodule PostsAdder do
  ...
  defp insert_post_to_user_posts({:error, _}, _new_post, _state) do
    ...
    update_meta_and_put_to_db(obj, _new_post, db_put)
  end
  defp insert_post_to_user_posts({:ok, _old_entry}, _new_post, _state) do
    ...
    update_meta_and_put_to_db(obj, _new_post, db_put, old_sec_idx)
  end
  ...
  defp insert_post_to_hash_tags({:ok, _old_entity}, _hash_tag, _new_post, _state) do
    ...
    old_sec_idx =
      :riakc_obj.get_secondary_index(_old_entity_meta, {:binary_index, <<"post_id">>})
    update_meta_and_put_to_db(obj, _new_post, db_put, old_sec_idx)
  end

  defp update_meta_and_put_to_db(obj, _new_post, db_put, old_sec_idx \\ []) do
    new_meta = obj
